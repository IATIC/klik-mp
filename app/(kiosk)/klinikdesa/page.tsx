...
export default function KlinikdesaPage() {
  ...
  return (
    ...
    >
      <div className="flex h-full flex-col items-center justify-center gap-5 animate-foundation-in">
        <span className="flex size-20 items-center justify-center rounded-full bg-rose-100 text-rose-700">
          <Construction aria-hidden="true" className="size-10" />
        </span>
        <h1 className="text-3xl font-extrabold sm:text-4xl">Klinikdesa</h1>
        <p className="max-w-md text-center text-lg text-muted-foreground">
          Fitur klinik desa akan segera tersedia.
        </p>
      </div>
    </KioskPage>
  );
